...
How would you handle the confounding variable of `geography` if you know that the process by which customers select the product is only based on the graphic and on geography? How would you handle the variable `geography` if the selection process were not based only on the graphic and on geography?
:::
