...
@exr-ch11-c02
a) If the p-value is small, then the probability of observing an estimate as extreme as the one you observed is unlikely.
...
@exr-ch11-c05
c) The mean of a variable

@exr-ch11-c06
d) A data point in the center of the distribution
