...
When formulating the hypothesis you first want to state the claim in mathematical notation. If the claim contains equality, it belongs in the null hypothesis and if it does not it belongs in the alternative hypothesis. Next decide if the claim is a two-tailed, right-tailed, or left-tailed test. @fig-tail-ch-12 provides an overview of the three possible scenarios.

<!-- ::: {#tbl-tail-ch-12 .cell tbl-cap="Overview of the three possible tail-test scenarios."} -->
...
```{r}
#| label: fig-tail-ch-12
#| fig-cap: "Formulating the Null and Alternative Hypothesis"
#| echo: false
#| message: false

knitr::include_graphics("images/ch12_tails.png")
```
