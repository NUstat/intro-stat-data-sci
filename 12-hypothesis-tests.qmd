...
When formulating the hypothesis you first want to state the claim in mathematical notation. If the claim contains equality, it belongs in the null hypothesis and if it does not it belongs in the alternative hypothesis. The three possible scenarios are shown below.
<!-- Next decide if the claim is a two-tailed, right-tailed, or left-tailed test. @tbl-tail-ch-12 provides an overview of the three possible scenarios. -->
