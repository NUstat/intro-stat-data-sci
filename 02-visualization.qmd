...
Use the `nba` dataset in the `ISDSdatasets` package for exercises @exr-ch02-app2, @exr-ch02-app3, and @exr-ch02-app4.
...
::: {#exr-ch02-adv1}
Start with your plot from @exr-ch02-app1. Let's clean up the graph a little by adding the following layers:
