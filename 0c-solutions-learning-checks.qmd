...
1. Figure @fig-reldiagram above showing how the various datasets can be joined will also be useful. 
1. Consider the data wrangling verbs in Table @tab-wrangle-summary-table as your toolbox!
